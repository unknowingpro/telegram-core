...
ALTER TABLE messages ADD COLUMN IF NOT EXISTS reply_parameters JSON NULL;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS provider_data TEXT NULL;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS need_name BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS need_phone_number BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS need_email BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS need_shipping_address BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS send_phone_number_to_provider BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS send_email_to_provider BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS is_flexible BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS photo_url VARCHAR(512) NULL;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS photo_size INT UNSIGNED NULL;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS photo_width INT UNSIGNED NULL;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS photo_height INT UNSIGNED NULL;
...
ALTER TABLE bot_accounts ADD COLUMN IF NOT EXISTS default_chat_admin_rights TEXT NULL;
ALTER TABLE bot_accounts ADD COLUMN IF NOT EXISTS default_chat_permissions TEXT NULL;
...
ALTER TABLE messages ADD COLUMN IF NOT EXISTS has_media_spoiler BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE messages ADD COLUMN IF NOT EXISTS media_group_id VARCHAR(64) NULL;
ALTER TABLE messages ADD COLUMN IF NOT EXISTS business_connection_id VARCHAR(64) NULL;
ALTER TABLE messages ADD COLUMN IF NOT EXISTS forward_from_chat_id BIGINT UNSIGNED NULL;
ALTER TABLE messages ADD COLUMN IF NOT EXISTS forward_from_message_id BIGINT UNSIGNED NULL;
ALTER TABLE messages ADD COLUMN IF NOT EXISTS forward_date TIMESTAMP NULL;
ALTER TABLE messages ADD COLUMN IF NOT EXISTS author_signature VARCHAR(255) NULL;
...
ALTER TABLE bot_accounts ADD COLUMN IF NOT EXISTS menu_button JSON NULL;
